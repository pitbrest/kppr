        ...
        <div className="">
          <div className="info-wrapper flex items-start justify-start flex-wrap text-sm">
            <div className="w-full">
              <div className="w-full bg-[--color-teal] text-[--color-light] flex items-center">
              ...
              <div className="w-full">
                <h3 className="text-sm min-[576px]:text-lg font-extrabold py-2 min-[576px]:py-4 ps-6 mb-3 w-full bg-[--color-teal] text-[--color-light] flex items-center hyphens-auto">
